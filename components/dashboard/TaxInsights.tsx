  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <Progress value={currentTaxRate} max={40} className="h-2" />
        ...
        <Progress value={optimizedTaxRate} max={40} className="h-2" indicatorClassName="bg-green-500" />
        
        <div className="mt-2 p-2 rounded bg-green-100 dark:bg-green-900/20 border border-green-200 dark:border-green-800">
      ...
      <div className="space-y-3">
        ...
        {savingsOpportunities.map((item) => (
          <div key={item.id} className="flex justify-between items-center p-2 rounded hover:bg-secondary/50 transition-colors cursor-pointer group">
            <div>
