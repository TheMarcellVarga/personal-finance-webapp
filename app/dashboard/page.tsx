    ...
    <TooltipProvider>
      <div className="min-h-screen bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-indigo-500/20 via-background to-background dark:from-indigo-950/20 dark:via-background dark:to-background">
        ...
        <main className="container mx-auto p-4 sm:p-6 pt-20 pb-16 relative z-10">
          ...
          {/* Performance Alert */}
          <Alert className="mb-6 border-green-200 bg-green-50/50 dark:border-green-800 dark:bg-green-950/50">
            <TrendingUp className="h-4 w-4 text-green-600 dark:text-green-400" />
            <AlertTitle className="text-green-800 dark:text-green-200">Great Progress!</AlertTitle>
            <AlertDescription className="text-green-700 dark:text-green-300">
              Your net worth increased by 12.5% this month. You're on track to meet your financial goals.
            </AlertDescription>
          </Alert>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mb-4 sm:mb-6">
            <Tooltip>
              <TooltipTrigger asChild>
                <Card className="border border-indigo-200/30 dark:border-indigo-800/30 bg-gradient-to-br from-blue-50/30 to-indigo-50/30 dark:from-blue-900/20 dark:to-indigo-900/20 shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer">
              ...
              <TooltipContent>
                <p>Your total net worth including assets and investments minus debts</p>
              </TooltipContent>
            </Tooltip>

            <Tooltip>
              <TooltipTrigger asChild>
                <Card className="border border-indigo-200/30 dark:border-indigo-800/30 bg-gradient-to-br from-indigo-50/30 to-purple-50/30 dark:from-indigo-900/20 dark:to-purple-900/20 shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer">
                  <CardContent className="p-3 sm:p-4">
                    <div className="flex flex-col">
              ...
              <TooltipContent>
                <p>Total income from all sources this month</p>
              </TooltipContent>
            </Tooltip>

            <Tooltip>
              <TooltipTrigger asChild>
                <Card className="border border-indigo-200/30 dark:border-indigo-800/30 bg-gradient-to-br from-purple-50/30 to-pink-50/30 dark:from-purple-900/20 dark:to-pink-900/20 shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer">
                  <CardContent className="p-3 sm:p-4">
                    <div className="flex flex-col">
              ...
              <TooltipContent>
                <p>Total expenses this month compared to your budget</p>
              </TooltipContent>
            </Tooltip>

            <Tooltip>
              <TooltipTrigger asChild>
                <Card className="border border-indigo-200/30 dark:border-indigo-800/30 bg-gradient-to-br from-pink-50/30 to-rose-50/30 dark:from-pink-900/20 dark:to-rose-900/20 shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer">
                  <CardContent className="p-3 sm:p-4">
                    <div className="flex flex-col">
              ...
              <TooltipContent>
                <p>Percentage of income saved each month</p>
              </TooltipContent>
            </Tooltip>
          </div>
